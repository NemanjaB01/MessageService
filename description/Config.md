...
- `User* getUser(const std::string& name) const`
  ...
  - Rückgabewert: 
    ...
    - ansonsten wird `nullptr` zurückgegeben (`nullptr` ist das C++ Equivalent zu `NULL`)
